...
/**
 * This is the main file of Ex0 (OOP), Do play with it and make sure you know
 * how to operate the simulator before starting to implement the algorithm.
 */
public class Ex0_main {
    public static Long ID0 = 319645735L, ID1 = 208640326L, ID2 = null;
    ...
    public static void main(String[] ar) {
        ...
        // ElevatorAlgo ex0_alg = new ShabatElevAlgo(Simulator_A.getBuilding()); // The
